...
public class Lab1Part2Tester {
    ...
    public static void testConstructorsAndGetters() {
        ...
        Student s2 = new Student("V0923094", 10);
        
        sID = s2.getSID();
        displayResults( sID.equals("V0923094"), "test args constructor and getSID");
        grade = s2.getGrade();
        displayResults( grade == 10, "test args constructor and getSID");
