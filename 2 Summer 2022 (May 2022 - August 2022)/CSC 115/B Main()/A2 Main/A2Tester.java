...
public class A2Tester {
    ...
    public static void movieActorAgeAtReleaseTests() {
        ...
        Movie m2 = new Movie("Nomadland", 2020);
        Actor a3 = new Actor("Frances", "McDormand", 1957, 4);
        Movie m3 = new Movie("Nomadland", 2020, a3);

        int result = m1.actorAgeAtRelease();
        int expected = 36;
        displayResults (result==expected,
                        "actorAgeAtRelease Test, 2005 birthYear 1969");

        m1.setLeadActor(a2);

        result = m1.actorAgeAtRelease();
        expected = 68;
        displayResults (result==expected,
                        "actorAgeAtRelease Test, 2005 birthYear 1969");

        result = m2.actorAgeAtRelease();
        expected = -1;
        displayResults (result==expected,
                        "actorAgeAtRelease Test, no actor");

        result = m3.actorAgeAtRelease();
        expected = 63;
        displayResults (result==expected,
                        "actorAgeAtRelease Test, 2020 birthYear 1957");
