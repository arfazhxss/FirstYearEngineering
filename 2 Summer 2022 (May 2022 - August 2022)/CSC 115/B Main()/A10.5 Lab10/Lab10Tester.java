...
public class Lab10Tester {
    ...
    public static void testNoCollisionHandling() {
        ...
        Student s5b = new Student("xej", 90);   //should hash to index 5
        ...
        try {
            ...
            displayResults (false,
                            "TableFullException should not have been thrown");
        } catch (CollisionException e) {
            displayResults (false,
                            "CollisionException should not have been thrown");
        }
        ...
        try {
            ...
            displayResults (true,
                            "CollisionException should have been thrown");
        }
        ...
        try {
            ...
            displayResults (false,
                            "TableFullException should have been thrown");
        } catch (TableFullException e) {
            displayResults (true,
                            "TableFullException should have been thrown");
        } catch (CollisionException e) {
        ...
        try {
            ...
            displayResults (false,
                            "KeyNotFoundException should not have been thrown");
        }
        ...
        try {
            ...
            displayResults(false,
                           "KeyNotFoundException should have been thrown");
        } catch (KeyNotFoundException e) {
            displayResults (true,
                            "KeyNotFoundException should have been thrown");
        }
    ...
    public static void testLinearProbing() {
        ...
        try {
            int grade = notFull.getLinearProbing("ops");
            displayResults(false,
                           "KeyNotFoundException should have been thrown");
