...
public class A9Tester {
    ...
    public static void addKeyValues (BinarySearchTree<String, Integer> t, String keys[], int[] values, int count){
    ...
    public static void testInsertSizeHeight() {
    ...
    public static void testInsertFind()    {
    ...
    public static void tree1Test() {
        ...
        System.out.println("TreeView:Tree1");
        TreeView<String,Integer> tv = new TreeView<String,Integer>(t);
        tv.dotPrint();

        
        List <Entry<String,Integer> > l = t.entryList();
        compareLists (tree1_keys_levelorder, tree1_values_levelorder, tree1_size, l);

        l = t.entryList(BinarySearchTree.BST_PREORDER);
        compareLists (tree1_keys_preorder, tree1_values_preorder, tree1_size, l);

        l = t.entryList(BinarySearchTree.BST_POSTORDER);
        compareLists (tree1_keys_postorder, tree1_values_postorder, tree1_size, l);

        l = t.entryList(BinarySearchTree.BST_INORDER);
        compareLists (tree1_keys_inorder, tree1_values_inorder, tree1_size, l);
    ...
    public static void tree2Test() {
        ...
        BinarySearchTree<String, Integer> t = new BinarySearchTree<String, Integer> ();
        addKeyValues(t,tree2_keys, tree2_values, tree2_to_add);
        ...
        System.out.println("TreeView:Tree2");
        TreeView<String,Integer> tv = new TreeView<String,Integer>(t);
        tv.dotPrint();

        displayResults(t.height() == tree2_height, "height tree2");
        List <Entry<String,Integer> > l = t.entryList();
        compareLists (tree2_keys_levelorder, tree2_values_levelorder, tree2_size, l);

        l = t.entryList(BinarySearchTree.BST_PREORDER);
        compareLists (tree2_keys_preorder, tree2_values_preorder, tree2_size, l);

        l = t.entryList(BinarySearchTree.BST_POSTORDER);
        compareLists (tree2_keys_postorder, tree2_values_postorder, tree2_size, l);

        l = t.entryList(BinarySearchTree.BST_INORDER);
        compareLists (tree2_keys_inorder, tree2_values_inorder, tree2_size, l);
    ...
    public static void tree3Test() {
        ...
        BinarySearchTree<String, Integer> t = new BinarySearchTree<String, Integer> ();
        addKeyValues(t,tree3_keys, tree3_values, tree3_to_add);

        displayResults(t.height() == tree3_height, "height tree3");
        List <Entry<String,Integer> > l = t.entryList();
        
        System.out.println("TreeView:Tree3");
        TreeView<String,Integer> tv = new TreeView<String,Integer>(t);
        tv.dotPrint();
        ...
        compareLists (tree3_keys_levelorder, tree3_values_levelorder, tree3_size, l);

        l = t.entryList(BinarySearchTree.BST_PREORDER);
        compareLists (tree3_keys_preorder, tree3_values_preorder, tree3_size, l);

        l = t.entryList(BinarySearchTree.BST_POSTORDER);
        compareLists (tree3_keys_postorder, tree3_values_postorder, tree3_size, l);

        l = t.entryList(BinarySearchTree.BST_INORDER);
        compareLists (tree3_keys_inorder, tree3_values_inorder, tree3_size, l);

        System.out.println("****** end insert traversals tree 3\n");

    }

    public static void tree4Test() {
        System.out.println("**** begin insert traversals tree 4");

        BinarySearchTree<String, Integer> t = new BinarySearchTree<String, Integer> ();
        addKeyValues(t,tree4_keys, tree4_values, tree4_to_add);

        displayResults(t.height() == tree4_height, "height tree4");
        
        System.out.println("TreeView:Tree4");
        TreeView<String,Integer> tv = new TreeView<String,Integer>(t);
        tv.dotPrint();
        ...
        List <Entry<String,Integer> > l = t.entryList();
        compareLists (tree4_keys_levelorder, tree4_values_levelorder, tree4_size, l);

        l = t.entryList(BinarySearchTree.BST_PREORDER);
        compareLists (tree4_keys_preorder, tree4_values_preorder, tree4_size, l);

        l = t.entryList(BinarySearchTree.BST_POSTORDER);
        compareLists (tree4_keys_postorder, tree4_values_postorder, tree4_size, l);

        l = t.entryList(BinarySearchTree.BST_INORDER);
        compareLists (tree4_keys_inorder, tree4_values_inorder, tree4_size, l);
    ...
    public static void map1Test() {
        ...
        displayResults(d.containsKey("abc"),"put update + containsKey true");
        displayResults(!d.containsKey("def"),"put update + containsKey false");

        try {
            int val = d.get("abc");
            displayResults(val == 15,"put + get, should be found");

        } catch (KeyNotFoundException e) {
            displayResults(false, "put + get, should be found");
        }

        try {
            int val = d.get("def");
            displayResults(false, "put + get should not be found");
            val = val + 1;

        } catch (KeyNotFoundException e) {
            displayResults(true, "put + get should not be found");
        }

        d.clear();
        displayResults(d.size() == 0,"clear");

        try {
            int val = d.get("abc");
            displayResults(false, "clear called, exception should be thrown");

        } catch (KeyNotFoundException e) {
            displayResults(true, "clear called, should not find key");
        }
