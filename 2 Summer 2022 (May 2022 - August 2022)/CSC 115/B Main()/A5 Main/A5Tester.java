...
public class A5Tester {
    ...
    public static int  stressTestSize = 1000;

    public static String listType = "linked";

    public static void main (String[] args) {
        // updates listType if command line argument is passed
        if (args.length == 1)
            listType = args[0];
...
// System.out.println(Arrays.toString(list.printAll()));
...
//System.out.println(Arrays.toString(list.printAll()));
    ...
    public static void testRemoveValue() {
        ...
        sFwd = list.toString();// result
        sRev = list.reverse();
        foward = p1 + " " + p3 + " " + p6; // expected
        reverse = p6 + " " + p3 + " " + p1;
